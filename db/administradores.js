...
export default class Administradores {
    ...
    autenticar = async (email, password) => {
        ...
        const [result] = await conexionDB.query(sql, [email]);
        if (result.length > 0) {
    ...
    crearUsuarioEmpleado = async (datos) => {
        ...
        const [result] = await conexionDB.query(sql, [datos.nombre, datos.apellido, datos.correoElectronico, hashedPassword, datos.idUsuarioTipo, datos.imagen, datos.activo]);
    ...
    actualizarEmpleado = async (idUsuario, datos) => {
        ...
        const [result] = await conexionDB.query(sql, params);
    ...
    crearOficina = async (datos) => {
        ...
        const [result] = await conexionDB.query(sql, [datos.nombre, datos.direccion, datos.telefono, datos.activo]);
    ...
    actualizarOficina = async (idOficina, datos) => {
        ...
        const [result] = await conexionDB.query(sql, [datos.nombre, datos.direccion, datos.telefono, datos.activo, idOficina]);
    ...
    agregarEmpleadoAOficina = async (idOficina, idEmpleado) => {
        ...
        const [result] = await conexionDB.query(sql, [idOficina, idEmpleado]);
